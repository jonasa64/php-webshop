...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" novalidate action="chage.php" method="post">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="cc-number" placeholder="" name="ccn" required >
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" id="cc-expiration" placeholder="" name="expriration" required >
                        <div class="invalid-feedback">
                ...
                <hr class="mb-4">
                <button class="btn btn-primary btn-lg btn-block" name="Submit" type="submit">Pay</button>
            </form>
        </div>
    </div>
